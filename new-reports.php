...
?>
<div class="wrap"> 
	<h2><?php _e('New Reports', 'pp-reportpost'); ?></h2>
	...
	<table class="widefat post fixed" cellspacing="0">
		...
		?>
			<tr <?php echo $alt;?>>
                ...
                <td align="center"><a href="<?php echo WP_PLUGIN_URL;?>/pp-reportpost/reports.php?id=<?php echo $report->id;?>&TB_iframe=true&type=reports" title="Report Details" class="thickbox" onclick="return false;"># View Details</a></td>
			</tr>
            <?php endforeach;?>
