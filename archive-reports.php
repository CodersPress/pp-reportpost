...
?>
<div class="wrap"> 
	<h2><?php _e('Archived Reports', 'pp-reportpost'); ?></h2>
    ...
    <div class="wprp-archive" id="delete-confirm" style="display:none">
    	<strong>Once deleted, It will be Permanently removed from database.</strong><br />
	...
	<table class="widefat post fixed" cellspacing="0">
		...
		?>
			<tr <?php echo $alt;?>>
                ...
                <td align="center"><a href="<?php echo WP_PLUGIN_URL;?>/pp-reportpost/reports.php?id=<?php echo $report->reportID;?>&display=archive&TB_iframe=true" title="Archived Report Details" class="thickbox" onclick="return false;"># View Details</a></td>
			</tr>
            <?php endforeach;?>
